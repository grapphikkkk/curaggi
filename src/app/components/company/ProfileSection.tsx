    ...
    >
      <div className="container">
        ...
        >
          ...
          >
            UX/UIデザイン・体験設計の専門家。電通デジタルにて約6年間、金融・通信・製薬・小売・自動車・流通・電力・官公庁等の大手企業向けにUXリサーチ・体験設計・デザインシステム構築・CMS設計を推進。アクセンチュア株式会社Songではサービスデザイナーとして、生成AI導入に伴う従業員体験向上や基幹システム刷新に伴うコールセンター業務のUX設計を担当。2026年4月に株式会社Curaggiを創業。
          </p>
